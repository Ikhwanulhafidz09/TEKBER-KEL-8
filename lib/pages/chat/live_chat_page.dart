...
class _LiveChatPageState extends State<LiveChatPage> {
  ...
  void _handleBotResponse(String input) async {
    ...
    if (trimmedInput == '1') {
      ...
      final Uri phoneUri = Uri(scheme: 'tel', path: '+62315994251'); // No Telp ITS
      ...
      // Tampilkan menu lagi setelah memberi info
      ...
      _addBotMessage(
        "Maaf, saya tidak mengerti pilihan '$input'.\n\n$_menuText"
      );
    }
  }
        ...
        title: Row(
          children: [
            ...
            Column(
              ...
              children: const [
                Text("Help Center ITS", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
  ...
  Widget _buildInputArea() {
    return Container(
      ...
      child: SafeArea(
        child: Column(
          children: [
            // Quick Action Chips (Agar user tidak perlu ngetik manual)
...
// Model Message sederhana (disimpan di file yang sama atau dipisah ke models/chat_message.dart)
class ChatMessage {
  String text;
  bool isUser;
  DateTime time;
