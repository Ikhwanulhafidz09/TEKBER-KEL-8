...
import 'package:myits_sarprass/pages/booking/detail_ruangan_screen.dart';
import 'informations/information_page.dart';
import 'profile/akun_profile.dart';
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) => DetailRuanganScreen(
                      roomId: roomId,
                      roomName: roomName,
                      imageUrl: (room['image_url'] ?? '') as String,
                    ),
                  ),
                );
              },
